...
parser MyParser(packet_in packet,
    ...
    state parse_probe_data {
        packet.extract(hdr.probe_data);
        meta.parser_metadata.remaining = hdr.probe_data.count;
...
control MyEgress(inout headers hdr,
    ...
    action add_swtrace(switchID_t swid) { 
        hdr.probe_data.count = hdr.probe_data.count + 1;
	...
	hdr.swtraces[0].delay = (time_t)standard_metadata.deq_timedelta;
